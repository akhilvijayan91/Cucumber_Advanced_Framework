...
public class LoginVerification extends driverInstance {
    ...
    public void theUserLoginToOrangeHRMApplicationWithAnd(String username, String password) throws IOException {
    ...
    public void theUserShouldLoginSucessfullyToOrangeHRMApplication() {
        Assertions.assertThat(getTitle()).containsIgnoringCase("dashboard");
    }
}
